...
namespace CeciDapper.Test.Fakers.Address
{
    public static class AddressFaker
    {
        public static Faker<CeciDapper.Domain.Entities.Address> AddressEntity()
        {
            return new Faker<CeciDapper.Domain.Entities.Address>()
                .CustomInstantiator(p => new CeciDapper.Domain.Entities.Address
                {
                    Id = p.Random.Int(),
