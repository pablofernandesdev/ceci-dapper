...
namespace CeciDapper.Test.Fakers.User
{
    public static class UserFaker
    {
        public static Faker<CeciDapper.Domain.Entities.User> UserEntity()
        {
            return new Faker<CeciDapper.Domain.Entities.User>()
                .CustomInstantiator(p => new CeciDapper.Domain.Entities.User
                {
                    ...
                    RefreshToken = new List<CeciDapper.Domain.Entities.RefreshToken>(),
                    RegistrationDate = p.Date.Recent(),
                    RegistrationToken = new List<CeciDapper.Domain.Entities.RegistrationToken>(),
                    Validated = p.Random.Bool(),
                    ValidationCode = new List<CeciDapper.Domain.Entities.ValidationCode>(),
