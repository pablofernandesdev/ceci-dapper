...
using CeciDapper.Test.Fakers.Register;
...
namespace CeciDapper.Test.Services
{
    public class RegisterServiceTest
    {
        ...
        public async Task Update_logged_in_user_address_successfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.Address.GetFirstOrDefaultAsync($"{nameof(Address.UserId)} = {Convert.ToInt32(userId)}" +
                    $" AND {nameof(Address.Id)} = {addressUpdateDTOFaker.AddressId}"))
        ...
        public async Task Update_logged_in_user_address_failed()
        {
            ...
            _mockUnitOfWork.Setup(x => x.Address.GetFirstOrDefaultAsync($"{nameof(Address.UserId)} = {Convert.ToInt32(userId)}" + $" AND {nameof(Address.Id)} = {addressUpdateDTOFaker.AddressId}"))
                        .ReturnsAsync(value: null);
        ...
        public async Task Inactivate_logged_in_user_address_successfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.Address.GetFirstOrDefaultAsync($"{nameof(Address.UserId)} = {Convert.ToInt32(userId)}" +
                    $" AND {nameof(Address.Id)} = {addressIdentifierDTOFaker.AddressId}"))
        ...
        public async Task Get_logged_in_user_address_exception()
        {
            ...
            _mockUnitOfWork.Setup(x => x.Address.GetFirstOrDefaultAsync($"{nameof(Address.UserId)} = {Convert.ToInt32(userId)}" + $" AND {nameof(Address.Id)} = {addressIdentifierDTOFaker.AddressId}"))
                .ThrowsAsync(new Exception());
