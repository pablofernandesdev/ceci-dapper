...
using CeciDapper.Test.Fakers.Email;
...
namespace CeciDapper.Test.Services
{
    public class UserServiceTest
    {
        ...
        public async Task Add_user_successfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.User.AddAsync(It.IsAny<User>()))
        ...
        public async Task Delete_user_successfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.User.GetFirstOrDefaultAsync($"{nameof(Role.Id)} = {userDeleteDTOFaker.UserId}"))
        ...
        public async Task Update_user_successfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.User.GetFirstOrDefaultAsync($"{nameof(User.Email)} = '{userUpdateDTOFaker.Email}'" +
                    $" AND {nameof(User.Id)} != {userUpdateDTOFaker.UserId}"))
                .ReturnsAsync(value: null);

            _mockUnitOfWork.Setup(x => x.User.GetFirstOrDefaultAsync($"{nameof(Role.Id)} = {userUpdateDTOFaker.UserId}"))
        ...
        public async Task Update_logged_user_successfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.User
                .GetFirstOrDefaultAsync($"{nameof(User.Email)} = '{userUpdateDTOFaker.Email}'" + $" AND {nameof(User.Id)} != {Convert.ToInt32(userId)}"))
                .ReturnsAsync(value: null);
        ...
        public async Task Failed_to_update_user_with_already_registered_email()
        {
            ...
            _mockUnitOfWork.Setup(x => x.User.GetFirstOrDefaultAsync($"{nameof(User.Email)} = '{userUpdateDTOFaker.Email}'" + $" AND {nameof(User.Id)} != {userUpdateDTOFaker.UserId}"))
                .ReturnsAsync(UserFaker.UserEntity().Generate());
        ...
        public async Task Update_user_role_successfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.User.GetFirstOrDefaultAsync($"{nameof(User.Id)} = {userRoleUpdateDTOFaker.UserId}"))
                .ReturnsAsync(userEntityFaker);
        ...
        public async Task Redefine_user_password_successfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.User.GetFirstOrDefaultAsync($"{nameof(User.Id)} = {Convert.ToInt32(userId)}"))
                .ReturnsAsync(userEntityFaker);
