...
using CeciDapper.WebApplication.Attribute;
using CeciDapper.WebApplication.Dependencys;
using CeciDapper.WebApplication.Extensions;
using CeciDapper.WebApplication.Filters;
...
namespace CeciDapper.WebApplication
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                var xmls = new List<string>(new string[] { Path.Combine(AppContext.BaseDirectory, "CeciDapper.WebApplication.xml"),
                    Path.Combine(AppContext.BaseDirectory, "CeciDapper.Domain.xml") });
